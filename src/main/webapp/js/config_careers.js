config.careers = {
  ...
  'Imperialer Psioniker' : {
    ...
    'gears' : [
      ...
      'Kleidung (schlechte Qualität)',
      [
        'Buch über Heilige des Imperiums',
        'Spielkarten',
        'Würfel'
      ],
      'Psi-Fokus',
      'Sanktionierungszeichen'
    ],
    'training' : {
      'kg' : [
        500, 750, 1000, 2500
  ...
  'Soldat' : {
    ...
    'gears' : [
      ...
      [
        'Söldnerlizenz',
        'Sprengkragen',
        'Des Imperialen Infanteristen inspirierende Instruktionen'
      ]
    ],
    'training' : {
      'kg' : [
